...
gifted({ nomCom: "sc", reaction: "🤍", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
gifted({ nomCom: "script", reaction: "🤍", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
gifted({ nomCom: "git", reaction: "🤍", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
